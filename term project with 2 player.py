...
def reset(app):
    ...
    if app.twoPlayer == True:
        ...
        app.twoPlayerx = (app.screenWidth / 2) - (app.cellWidth * (app.mapSize - 1))
        app.twoPlayery = app.playery
    app.monsterHealth = 10
    app.monsters = []
    if app.buildMonsters == []:
    ...
    # app.stepsPerSecond = 10**99999
    app.playerHealth = 100
    app.twoPlayerHealth = 100
    app.playerAlive = True
    app.twoPlayerAlive = True
    # app.zombieurl = 'https://i.ibb.co/F3dW7Kj/zombie-pic-11zon.png'
    app.chests = []
    if app.buildChests == []:
    ...
    if app.buildChests != []:
        # print('hi')
        for row in range(len(app.buildChestMap)):
            for col in range(len(app.buildChestMap)):
                if app.buildChestMap[row][col] == 1:
                    chestRow = math.floor(row / 8)
                    chestCol = math.floor(col / 8)
                    randNoise = random.randint(1, 10)
                    chestx = chestCol * app.cellWidth + (app.cellWidth / 2)
                    chesty = chestRow * app.cellHeight + (app.cellHeight / 2)
                    app.chests.append([chestx, chesty])
    app.chestMapSize = app.mapSize * 8
    app.chestMapCellWidth = app.cellWidth / 8
    app.chestMapCellHeight = app.cellHeight / 8
    app.chestTileSize = app.tileSize / 8
...
def redrawAll(app):
    ...
    if app.twoPlayer == True and app.twoInitializer == True:
        ...
        for i in range(3):
            for j in range(6):
                drawLabel(f'{level}', ((app.screenWidth / 2) + widths[j]) + 37.5, (app.screenHeight / 2) - (175 - 150 * i) + 37.5)
                level += 1
        drawLabel('19', ((app.screenWidth / 2) - 100 + 37.5), (app.screenHeight / 2) + 275 + 37.5)
        drawLabel('20', ((app.screenWidth / 2) + 50 + 37.5), (app.screenHeight / 2) + 275 + 37.5)
    
    elif app.build == True and app.win == False and app.playerAlive == True and app.onePlayer == False:
        ...
        if app.buildDone == True:
            ...
            drawRect(app.screenWidth / 2 - 400, app.screenHeight / 2 + 275, 100, 100, fill = None, border = 'red')
            drawLabel('Place Wall', app.screenWidth / 2 - 300 - 50, app.screenHeight / 2 + 275 + 50)
            drawRect(app.screenWidth / 2 - 275, app.screenHeight / 2 + 275, 100, 100, fill = None, border = 'red')
            drawLabel('Place Exit', app.screenWidth / 2 - 275 + 50, app.screenHeight / 2 + 275 + 50)
            drawRect(app.screenWidth / 2 - 150, app.screenHeight / 2 + 275, 100, 100, fill = None, border = 'red')
            drawLabel('Place Monsters', app.screenWidth / 2 - 150 + 50, app.screenHeight / 2 + 275 + 50)
            drawRect(app.screenWidth / 2, app.screenHeight / 2 + 275, 100, 100, fill = None, border = 'red')
            drawLabel('Place Chests', app.screenWidth / 2 + 50, app.screenHeight / 2 + 275 + 50)
            drawRect(app.screenWidth / 2 + 150, app.screenHeight / 2 + 275, 100, 100, fill = None, border = 'red')
            drawLabel('Go Play in', app.screenWidth / 2 + 150 + 50, app.screenHeight / 2 + 275 + 40)
            drawLabel('One-Player Mode', app.screenWidth / 2 + 150 + 50, app.screenHeight / 2 + 275 + 70)
            drawRect(app.screenWidth / 2 + 300, app.screenHeight / 2 + 275, 100, 100, fill = None, border = 'red')
            drawLabel('Go Play in', app.screenWidth / 2 + 300 + 50, app.screenHeight / 2 + 275 + 40)
            drawLabel('Two-Player Mode', app.screenWidth / 2 + 300 + 50, app.screenHeight / 2 + 275 + 70)
            ...
            # if isinstance(app.placeWall, list) and app.placeWall[0] == True and app.placeWall[1] >= (app.screenWidth / 2 - 200) and app.placeWall[1] <= (app.screenWidth / 2 - 200 + 400) and app.placeWall[2] >= (app.screenHeight / 2 - 175) and app.placeWall[2] <= (app.screenHeight / 2 - 175 + 400):
            ...
            # if isinstance(app.placeExit, list) and app.placeExit[0] == True and app.placeExit[1] >= (app.screenWidth / 2 - 200) and app.placeExit[1] <= (app.screenWidth / 2 - 200 + 400) and app.placeExit[2] >= (app.screenHeight / 2 - 175) and app.placeExit[2] <= (app.screenHeight / 2 - 175 + 400):
            ...
            for i in range(len(app.buildChests)):
                ...
                drawLabel('Weapons Here', chestcx, chestcy)
    ...
    elif app.onePlayer == True and (app.win == True or app.playerAlive == False) and app.build == False:
        if app.playerAlive == False:
            drawLabel('You died', app.screenWidth / 2, app.screenHeight / 2 - 300)
        if app.win == True:
            drawLabel('You won', app.screenWidth / 2, app.screenHeight / 2 - 300)
        drawRect((app.screenWidth / 2) - 150, (app.screenHeight / 2) - 150, 300, 100, fill=None, border='red')
        drawRect((app.screenWidth / 2) - 150, (app.screenHeight / 2), 300, 100, fill=None, border='red')
        drawRect((app.screenWidth / 2) - 150, (app.screenHeight / 2) + 150, 300, 100, fill=None, border='red')
        ...
        drawLabel('Choose a Different Level', (app.screenWidth / 2), (app.screenHeight / 2) + 200)

    elif app.onePlayer == True and (app.win == True or app.playerAlive == False) and app.build == True:
        if app.playerAlive == False:
            drawLabel('You died', app.screenWidth / 2, app.screenHeight / 2 - 300)
        if app.win == True:
            drawLabel('You won', app.screenWidth / 2, app.screenHeight / 2 - 300)
        ...
        # drawRect((app.screenWidth / 2) - 400, (app.screenHeight / 2) - 175, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 250, (app.screenHeight / 2) - 175, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 100, (app.screenHeight / 2) - 175, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 50, (app.screenHeight / 2) - 175, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 200, (app.screenHeight / 2) - 175, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 350, (app.screenHeight / 2) - 175, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 400, (app.screenHeight / 2) - 25, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 250, (app.screenHeight / 2) - 25, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 100, (app.screenHeight / 2) - 25, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 50, (app.screenHeight / 2) - 25, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 200, (app.screenHeight / 2) - 25, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 350, (app.screenHeight / 2) - 25, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 400, (app.screenHeight / 2) + 125, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 250, (app.screenHeight / 2) + 125, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 100, (app.screenHeight / 2) + 125, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 50, (app.screenHeight / 2) + 125, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 200, (app.screenHeight / 2) + 125, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 350, (app.screenHeight / 2) + 125, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) - 100, (app.screenHeight / 2) + 275, 75, 75, fill=None, border='red')
        # drawRect((app.screenWidth / 2) + 50, (app.screenHeight / 2) + 275, 75, 75, fill=None, border='red')

    elif app.onePlayer == True and app.oneInitializer == False:
        # if app.playerAlive == False:
        #     drawRect(0, 0, app.screenWidth, app.screenHeight, fill=None)
        #     # drawLabel('You died', app.screenWidth / 2, app.screenHeight / 2)

        # elif app.win == True:
        #     drawRect(0, 0, app.screenWidth, app.screenHeight, fill=None)
        #     # drawLabel('You won', app.screenWidth / 2, app.screenHeight / 2)
        ...
        if app.win == False:
            ...
            # drawRect(app.screenWidth / 2, app.screenHeight / 2, app.screenWidth / 2, app.screenHeight / 2, fill='black')
            ...
            drawCircle(int(app.playerx), int(app.playery), 8, fill="green")
            for monster in app.monsters:
                drawCircle(int(monster[0]), int(monster[1]), 8, fill='red')
            for chest in app.chests:
                drawCircle(int(chest[0]), int(chest[1]), 8, fill='brown')
                drawLabel('Weapons here', int(chest[0]), int(chest[1]))
            ...
            for ray in range(app.castedRays):
                ...
                for depth in range(app.maxDepth):
                    ...
                    if app.map[row][col] == 1:
                        ...
                        drawRect(app.screenWidth / 2 + (ray * app.scale), (app.screenWidth / 4 ) - wallHeight / 2, app.scale, wallHeight, fill='white')
                    ...
                    if app.monsterMap[monsterRow][monsterCol] == 1:
                        ...
                        #calculate wall height
                        wallHeight = (21000 / (depth + 0.0001))
                        zombieColor = gradient('blue', 'green', start='bottom')
                        drawRect(app.screenWidth / 2 + (ray * app.scale), (app.screenWidth / 4) - wallHeight / 2, app.scale, wallHeight, fill=zombieColor)
                        # drawLabel('Zombie', (app.screenWidth / 2 + (ray * app.scale)) + (app.scale / 2), ((app.screenWidth / 4) - wallHeight / 2) + (wallHeight / 2), size=32, fill='white', align='left-top')
                        # drawImage(app.zombieurl, app.screenWidth / 2 + (ray * app.scale), (app.screenWidth / 4) - wallHeight / 2, width = app.scale, height = wallHeight)

                        break

                    if app.chestMap[chestRow][chestCol] == 1:
                    ...
                    # print(app.monsterMap)
                        ...
                        # for i in range(len(app.monsters)):
                        #     monsterHeight = (10500 / (depth + 0.0001))
                        #     drawRect(app.screenWidth / 2 + (ray * app.scale) +  app.monsters[i][0], (app.screenWidth / 4 ) - wallHeight / 2 + app.monsters[i][1], app.scale, monsterHeight)
    ...
    if app.twoPlayer == True and app.twoInitializer == False:
        # if app.twoPlayerAlive == False or app.twoPlayerEnd == True or app.twoPlayerHealth <= 0:
        #     pass
        #     # drawRect(0, 0, 20, 20, fill='white')
        #     # drawLabel('You died', app.screenWidth / 4, app.screenHeight / 2)

        if app.twoPlayerAlive == False and app.twoPlayerEnd == True:
            pass
            # drawRect(0, 0, app.screenWidth / 2, app.screenHeight, fill='white')
            # drawLabel('You died', *app.screenWidth / 4, app.screenHeight / 2)
        ...
        for ray in range(app.castedRays):
            ...
            for depth in range(app.maxDepth):
                ...
                if app.map[row][col] == 1:
                    ...
                    #draw 3D projection (rectangle by rectangle)
                    drawRect((ray * app.scale), (app.screenWidth / 4 ) - wallHeight / 2, app.scale, wallHeight, fill='white')
                ...
                if app.monsterMap[monsterRow][monsterCol] == 1:
                    ...
                    wallHeight = (21000 / (depth + 0.0001))
                    zombieColor = gradient('blue', 'green', start='bottom')
                    drawRect((ray * app.scale), (app.screenWidth / 4) - wallHeight / 2, app.scale, wallHeight, fill=zombieColor)
                    # drawLabel('Zombie', (app.screenWidth / 2 + (ray * app.scale)) + (app.scale / 2), ((app.screenWidth / 4) - wallHeight / 2) + (wallHeight / 2), size=32, fill='white', align='left-top')
                    # drawImage(app.zombieurl, app.screenWidth / 2 + (ray * app.scale), (app.screenWidth / 4) - wallHeight / 2, width = app.scale, height = wallHeight)
                ...
                if app.player1Map[player1Row][player1Col] == 1:
                    ...
                    drawRect((ray * app.scale), (app.screenWidth / 4) - player1Height / 2, app.scale, player1Height, fill='red')
                    break
        ...
        for ray in range(app.castedRays):
            ...
            for depth in range(app.maxDepth):
                ...
                if app.player2Map[player2Row][player2Col] == 1:
                    ...
                    drawRect(app.screenWidth / 2 + (ray * app.scale), (app.screenWidth / 4) - player2Height / 2, app.scale, player2Height, fill='red')
                    break
    ...
    if (app.playerAlive == False or app.onePlayerEnd == True or app.playerHealth <= 0) and app.win == False and app.twoWin == False and app.twoPlayerHealth >= 0 and app.onePlayer == False:
        ...
        drawLabel('You died', 3*app.screenWidth / 4, app.screenHeight / 2)
    ...
    if app.win == True and app.twoWin == False and app.onePlayer == False:
        drawRect(0, 0, app.screenWidth, app.screenHeight, fill='white')
        drawLabel('Player 1 Won', app.screenWidth / 2, app.screenHeight / 2 - 300)
        ...
        drawLabel('Play Again', (app.screenWidth / 2), (app.screenHeight / 2) - 100)
        drawLabel('Return Home', (app.screenWidth / 2), (app.screenHeight / 2) + 50)
        drawLabel('Play a Different Level', (app.screenWidth / 2), (app.screenHeight / 2) + 200)
    
    if app.twoWin == True and app.win == False:
        drawRect(0, 0, app.screenWidth, app.screenHeight, fill='white')
        drawLabel('Player 2 Won', app.screenWidth / 2, app.screenHeight / 2 - 300)
    ...
    if (app.playerAlive == False or app.onePlayerEnd == True or app.playerHealth <= 0) and (app.twoPlayerAlive == False or app.twoPlayerEnd == True or app.twoPlayerHealth <= 0):
        drawRect(0, 0, app.screenWidth, app.screenHeight , fill='white')
        drawLabel('Both Players Died', app.screenWidth / 2, app.screenHeight / 2 - 300)
    ...
    if 'q' in keys:
        if app.twoSword == True:
            ...
            while i != len(app.monsters):
                if distance(app.monsters[i][0], app.monsters[i][1], app.twoPlayerx, app.twoPlayery) < app.mapSize:
                    app.monsters[i][3] -= 10
                    if app.woodenSword == True:
                        app.monsters[i][3] -= 1
                    if app.stoneSword == True:
                ...
                i += 1
            if app.twoPlayer == True:
                if distance(app.playerx, app.playery, app.twoPlayerx, app.twoPlayery) < 20:
                    app.playerHealth -= 10
...
def checkIfNearbyMonsters(app):
    for monster in app.monsters:
        if distance(monster[0], monster[1], app.playerx, app.playery) < 10:
            app.playerHealth -= 10
        if app.twoPlayerx != None and app.twoPlayery != None:
            if distance(monster[0], monster[1], app.twoPlayerx, app.twoPlayery) < 10:
...
def onStep(app):
    ...
    for i in range(len(app.chests)):
        ...
        # playerChestx = chestCol * app.cellWidth + (app.cellWidth / 2)
        # playerChesty = chestRow * app.cellHeight + (app.cellHeight / 2)
        # print(chestRow, chestCol)
        # print(playerChestRow, playerChestCol)
        # subtractor = 5
        # if (playerChestRow - subtractor) <= chestRow and (playerChestRow + subtractor) >= chestRow and (playerChestCol - subtractor) <= chestCol and (playerChestCol + subtractor) >= chestCol:
        #     app.sword = True
        #     app.woodenSword = False
        #     app.stoneSword = False
        #     app.ironSword = False
    ...
    # for i in range(len(app.chests)):
    #     if distance(app.chests[i][0], app.chests[i][1], app.playerx, app.playery) < 10:
    #         app.sword = True
    #         app.chests.pop(i)
    i = 0
    while i < len(app.chests):
        if distance(app.chests[i][0], app.chests[i][1], app.playerx, app.playery) < 20:
            app.sword = True
            app.sword = True
            app.woodenSword = False
            app.stoneSword = False
            ...
            app.chestMap[chestRow][chestCol] = 0
            if app.build == True:
                for rowdy in range(-4, 4):
                    for coldx in range(-4, 4):
    ...
    if app.twoPlayerx != None and app.twoPlayery != None:
        i = 0
        while i < len(app.chests):
            if distance(app.chests[i][0], app.chests[i][1], app.twoPlayerx, app.twoPlayery) < 20:
                app.twoSword = True
                app.twoWoodenSword = False
                app.twoStoneSword = False
                app.twoIronSword = False
...
def onMousePress(app, mouseX, mouseY):
    ...
    if isinstance(app.placeChest, list) and app.placeChest[0] == True:
        ...
        if app.buildChestMap == []:
            for row in range(int(app.userInput) * 8):
                app.buildChestMap.append([0] * int(app.userInput) * 8)
                # app.buildChestMapCopy = app.buildChestMap
        if mouseX >= (app.screenWidth / 2 - 200) and mouseX <= (app.screenWidth /2 - 200 + 400) and mouseY >= (app.screenHeight / 2 - 175) and mouseY <= (app.screenHeight / 2 - 175 + 400):
            app.buildChests.append([mouseX, mouseY])
            # app.buildChestsCopy = app.buildChests
        cellDisplaySize = 400 / int(app.userInput)
        leftDistance = app.screenWidth / 2 - 200
        topDistance = app.screenHeight / 2 - 175
        for i in range(len(app.buildChests)):
            buildChestRow = math.floor((app.buildChests[i][1] - topDistance) / (cellDisplaySize / 8))
            buildChestCol = math.floor((app.buildChests[i][0] - leftDistance) / (cellDisplaySize / 8))
            if 0 <= buildChestRow <= int(app.userInput) * 8 and 0 <= buildChestCol <= int(app.userInput) * 8:
                app.buildChestMap[buildChestRow][buildChestCol] = 1
                # app.buildChestMapCopy[buildChestRow][buildChestCol] = 1


    if app.build == True and app.buildDone == True:
        if mouseX >= (app.screenWidth / 2 - 400) and mouseX <= (app.screenWidth / 2 - 400 + 100) and mouseY >= (app.screenHeight / 2 + 275) and mouseY <= (app.screenHeight / 2 + 275 + 100):
            print('Place Walls')
            app.placeMonster = False
            app.placeChest = False
            app.placeExit = False
            app.placeWall = [True, mouseX, mouseY]
        if mouseX >= (app.screenWidth / 2 - 275) and mouseX <= (app.screenWidth / 2 - 275 + 100) and mouseY >= (app.screenHeight / 2 + 275) and mouseY <= (app.screenHeight / 2 + 275 + 100):
            print('Place Exit')
            app.placeMonster = False
            app.placeChest = False
            app.placeWall = False
            app.placeExit = [True, mouseX, mouseY]
        if mouseX >= (app.screenWidth / 2 - 150) and mouseX <= (app.screenWidth / 2 - 150 + 100) and mouseY >= (app.screenHeight / 2 + 275) and mouseY <= (app.screenHeight / 2 + 275 + 100):
            print('Place Monsters')
            app.placeWall = False
            app.placeChest = False
            app.placeMonster = [True, mouseX, mouseY]
            app.placeExit = False
        if mouseX >= (app.screenWidth / 2) and mouseX <= (app.screenWidth / 2 + 100) and mouseY >= (app.screenHeight / 2 + 275) and mouseY <= (app.screenHeight / 2 + 275 + 100):
            print('Place Chests')
            app.placeWall = False
            app.placeMonster = False
    ...
    elif app.twoPlayer == True and app.twoInitializer == False:
    ...
    if app.onePlayer == True or app.twoPlayer == True:
        ...
        # if app.swing == True:
        #     for i in range(len(app.monsters)):
        #         if distance(app.monsters[i][0], app.monsters[i][1], app.playerx, app.playery) < app.mapSize:
        #             if app.woodenSword == True:
        #                 app.monsters[i][3] -= 1
        #             if app.stoneSword == True:
        #                 app.monsters[i][3] -= 2
...
# def buildOnePlayerInitializer(app):
#     app.buildMapSize = int(app.userInput)
#     app.monsterCount = 1
#     app.chestCount = 1
#     app.onePlayer = True
#     app.oneInitializer = False
...
def onePlayerInExit(app):
    ...
    if app.exitRow != 0:
        ...
        # leftDistance = app.screenWidth / 2 - 200
        # topDistance = app.screenHeight / 2 - 175
        # playerRow = math.floor((app.playery - topDistance) / cellDisplaySize)
        # playerCol = math.floor((app.playerx - leftDistance) / cellDisplaySize)
