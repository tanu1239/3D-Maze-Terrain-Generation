            ...
            for ray in range(app.castedRays):
                ...
                for depth in range(app.maxDepth):
                    ...
                    if app.chestMap != [] and app.chestMap[chestRow][chestCol] == 1:
                        ...
                        #     for col in range(len(app.chestMap)):
...
def onMousePress(app, mouseX, mouseY):
    ...
    if isinstance(app.placeWall, list) and app.placeWall[0] == True:
        ...
        if 0 <= row <= int(app.userInput) and 0 <= col <= int(app.userInput):
            ...
            if counter == 0:
                app.buildMap[row][col] = 1
        # if app.placeWall[1] >= (app.screenWidth / 2 + 300) and app.placeWall[1] <= (app.screenWidth / 2 + 400) and app.placeWall[2] >= (app.screenHeight / 2 + 25) and app.placeWall[2] <= (app.screenHeight / 2 + 125) and len(app.walls) > 0:
    ...
    if isinstance(app.placeExit, list) and app.placeExit[0] == True:
        ...
        if app.placeExit[0] == True and app.placeExit[1] >= (app.screenWidth / 2 - 200) and app.placeExit[1] <= (app.screenWidth / 2 - 200 + 400) and app.placeExit[2] >= (app.screenHeight / 2 - 175) and app.placeExit[2] <= (app.screenHeight / 2 - 175 + 400):
                ...
                if row == 0 or col == 0 or row == int(app.userInput) -1 or col == int(app.userInput) - 1:
                    app.exit.append((row, col))
        # if app.placeExit[1] >= (app.screenWidth / 2 + 300) and app.placeExit[1] <= (app.screenWidth / 2 + 400) and app.placeExit[2] >= (app.screenHeight / 2 + 25) and app.placeExit[2] <= (app.screenHeight / 2 + 125) and len(app.exit) > 0:
        #     rowPop = app.exit[-1][0]
        #     colPop = app.exit[-1][1]
        #     print(len(app.exit))
        #     app.exit.pop()
    ...
    if isinstance(app.placeMonster, list) and app.placeMonster[0] == True:
        ...
        # if app.placeMonster[1] >= (app.screenWidth / 2 + 300) and app.placeMonster[1] <= (app.screenWidth / 2 + 400) and app.placeMonster[2] >= (app.screenHeight / 2 + 25) and app.placeMonster[2] <= (app.screenHeight / 2 + 125) and len(app.buildMonsters) > 0:
    ...
    if isinstance(app.placeChest, list) and app.placeChest[0] == True:
        ...
        # if app.placeChest[1] >= (app.screenWidth / 2 + 300) and app.placeChest[1] <= (app.screenWidth / 2 + 400) and app.placeChest[2] >= (app.screenHeight / 2 + 25) and app.placeChest[2] <= (app.screenHeight / 2 + 125) and len(app.buildChests) > 0:
    ...
    if isinstance(app.placeSpawn, list) and app.placeSpawn[0] == True:
        ...
        # if mouseX >= (app.screenWidth / 2 + 300) and mouseX <= (app.screenWidth / 2 + 400) and mouseY >= (app.screenHeight / 2 + 25) and mouseY <= (app.screenHeight / 2 + 125) and len(app.spawningLocations) > 0:
