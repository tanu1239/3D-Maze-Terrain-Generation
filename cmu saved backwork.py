...
def reset(app):
    ...
    if app.buildChests != []:
        ...
        #             chestRow = math.floor(row / 16)
        #             chestCol = math.floor(col / 16)
        #             randNoise = random.randint(1, 10)
...
def onStep(app):
    ...
    while i < len(app.chests):
        if distance(app.chests[i][0], app.chests[i][1], app.playerx, app.playery) < 30:
            app.sword = True
            app.sword = True
            app.woodenSword = False
            app.stoneSword = False
    ...
    if app.twoPlayerx != None and app.twoPlayery != None:
        i = 0
        while i < len(app.chests):
            if distance(app.chests[i][0], app.chests[i][1], app.twoPlayerx, app.twoPlayery) < 30:
                app.twoSword = True
                app.twoWoodenSword = False
                app.twoStoneSword = False
                app.twoIronSword = False
