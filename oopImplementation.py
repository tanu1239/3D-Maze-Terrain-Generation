...
def onAppStart(app): 
    ...
    app.buildChestsCopy = []
    player1.playerMapSize = 1
    player1.playerCellWidth = 1
    player1.playerCellHeight = 1
    player2.playerMapSize = 1
    player2.playerCellWidth = 1
    player2.playerCellHeight = 1
...
def redrawAll(app):
    ...
    if player1.win == True and player2.win == False and player1.player == False and app.build == True:
        darkBlue = rgb(0, 4, 253)
        lightBlue = rgb(0, 252, 246)
        drawRect(0, 0, app.screenWidth, app.screenHeight, fill = gradient(darkBlue, lightBlue, start='bottom'))
        drawLabel('Player 1 Won', app.screenWidth / 2, app.screenHeight / 2 - 300, size = 25)
    ...
    if player2.win == True and player1.win == False and app.home == False and player1.player == False and app.build == True:
        darkBlue = rgb(0, 4, 253)
        lightBlue = rgb(0, 252, 246)
        drawRect(0, 0, app.screenWidth, app.screenHeight, fill = gradient(darkBlue, lightBlue, start='bottom'))
        drawLabel('Player 2 Won', app.screenWidth / 2, app.screenHeight / 2 - 300, size = 25)
    ...
    if (player1.playerHealth <= 0) and (player2.playerHealth <= 0) and player1.player == False and app.build == True:
        darkBlue = rgb(0, 4, 253)
        lightBlue = rgb(0, 252, 246)
        drawRect(0, 0, app.screenWidth, app.screenHeight, fill = gradient(darkBlue, lightBlue, start='bottom'))
        drawLabel('Both Players Died', app.screenWidth / 2, app.screenHeight / 2 - 300, size = 25)
...
def onKeyPress(app, key):
    if key == 'space':
        if player1.sword == True:
            if len(player1.collectedSwords) == 1:
                pass
            else:
                index = None
                length = len(player1.collectedSwords)
                if player1.currSword == 'wood':
                    index = player1.collectedSwords.index('wood')
                if player1.currSword == 'stone':
                    index = player1.collectedSwords.index('stone')
                if player1.currSword == 'iron':
                    index = player1.collectedSwords.index('iron')
                if player1.currSword == 'gold':
                    index = player1.collectedSwords.index('gold')
                if player1.currSword == 'diamond':
                    index = player1.collectedSwords.index('diamond')
                ...
                player1.diamondSword = False
                player1.currSword = None
                if player1.collectedSwords[newIndex] == 'wood':
                    player1.woodenSword = True
                    player1.currSword = 'wood'
                    print('now wood')
                if player1.collectedSwords[newIndex] == 'stone':
                    player1.stoneSword = True
                    player1.currSword = 'stone'
                    print('now stone')
                if player1.collectedSwords[newIndex] == 'iron':
                    player1.ironSword = True
                    player1.currSword = 'iron'
                    print('now iron')
                if player1.collectedSwords[newIndex] == 'gold':
                    player1.goldenSword = True
                    player1.currSword = 'gold'
                    print('now gold')
                if player1.collectedSwords[newIndex] == 'diamond':
                    player1.diamondSword = True
                    player1.currSword = 'diamond'
                    print('now diamond')
    if key == 'e':
       if player2.sword == True:
            if len(player2.collectedSwords) == 1:
                pass
            else:
                index = None
                length = len(player2.collectedSwords)
                if player2.currSword == 'wood':
                    index = player2.collectedSwords.index('wood')
                if player2.currSword == 'stone':
                    index = player2.collectedSwords.index('stone')
                if player2.currSword == 'iron':
                    index = player2.collectedSwords.index('iron')
                if player2.currSword == 'gold':
                    index = player2.collectedSwords.index('gold')
                if player2.currSword == 'diamond':
                    index = player2.collectedSwords.index('diamond')
                newIndex = (index + 1) % length
                player2.sword = True
                player2.woodenSword = False
                player2.stoneSword = False
                ...
                player2.diamondSword = False
                player2.currSword = None
                if player2.collectedSwords[newIndex] == 'wood':
                    player2.woodenSword = True
                    player2.currSword = 'wood'
                    print('now wood')
                if player2.collectedSwords[newIndex] == 'stone':
                    player2.stoneSword = True
                    player2.currSword = 'stone'
                    print('now stone')
                if player2.collectedSwords[newIndex] == 'iron':
                    player2.ironSword = True
                    player2.currSword = 'iron'
                    print('now iron')
                if player2.collectedSwords[newIndex] == 'gold':
                    player2.goldenSword = True
                    player2.currSword = 'gold'
                    print('now gold')
                if player2.collectedSwords[newIndex] == 'diamond':
                    player2.diamondSword = True
                    player2.currSword = 'diamond'
                    print('now diamond')
    if app.build == True:
        if key.isdigit() == True:
...
def onStep(app):
    ...
    for i in range(len(app.chests)):
        chestCol = math.floor(app.chests[i][0] / app.chestMapCellWidth)
        chestRow = math.floor(app.chests[i][1] / app.chestMapCellHeight)
        playerChestRow = math.floor(player1.playery / app.chestMapCellHeight)
        playerChestCol = math.floor(player1.playerx / app.chestMapCellWidth)
    i = 0
    while i < len(app.chests):
        if distance(app.chests[i][0], app.chests[i][1], player1.playerx, player1.playery) < 25:
            ...
            if swordSelector <= 25:
                player1.woodenSword = True
                if 'wood' not in player1.collectedSwords:
                    player1.collectedSwords.append('wood')
                player1.currSword = 'wood'
            if swordSelector >= 26 and swordSelector <= 55:
                player1.stoneSword = True
                if 'stone' not in player1.collectedSwords:
                    player1.collectedSwords.append('stone')
                player1.currSword = 'stone'
            if swordSelector >= 56 and swordSelector <= 70:
                player1.ironSword = True
                if 'iron' not in player1.collectedSwords:
                    player1.collectedSwords.append('iron')
                player1.currSword = 'iron'
            if swordSelector >= 71 and swordSelector <= 80:
                player1.goldenSword = True
                if 'gold' not in player1.collectedSwords:
                    player1.collectedSwords.append('gold')
                player1.currSword = 'gold'
            if swordSelector >= 81 and swordSelector <= 85:
                player1.diamondSword = True
                if 'diamond' not in player1.collectedSwords:
                    player1.collectedSwords.append('diamond')
                player1.currSword = 'diamond'
            if swordSelector >= 86 and swordSelector <= 95:
                player1.playerHealth = 500
                player1.playerHealthBoost = [True, 0]
            if swordSelector >= 96:
                player1.playerShield = [True, 0]
            print(player1.collectedSwords)
    ...
    if player2.playerx != None and player2.playery != None:
        ...
        while i < len(app.chests):
            if distance(app.chests[i][0], app.chests[i][1], player2.playerx, player2.playery) < 25:
                ...
                if swordSelector <= 25:
                    player2.woodenSword = True
                    if 'wood' not in player2.collectedSwords:
                        player2.collectedSwords.append('wood')
                    player2.currSword = 'wood'
                if swordSelector >= 26 and swordSelector <= 55:
                    player2.stoneSword = True
                    if 'stone' not in player2.collectedSwords:
                        player2.collectedSwords.append('stone')
                    player2.currSword = 'stone'
                if swordSelector >= 56 and swordSelector <= 70:
                    player2.ironSword = True
                    if 'iron' not in player2.collectedSwords:
                        player2.collectedSwords.append('iron')
                    player2.currSword = 'iron'
                if swordSelector >= 71 and swordSelector <= 80:
                    player2.goldenSword = True
                    if 'gold' not in player2.collectedSwords:
                        player2.collectedSwords.append('gold')
                    player2.currSword = 'gold'
                if swordSelector >= 81 and swordSelector <= 85:
                    player2.diamondSword = True
                    if 'diamond' not in player2.collectedSwords:
                        player2.collectedSwords.append('diamond')
                    player2.currSword = 'diamond'
                if swordSelector >= 86 and swordSelector <= 95:
                    player2.playerHealth = 500
                    player2.playerHealthBoost = [True, 0]
                if swordSelector >= 96:
                    player2.playerShield = [True, 0]
                print(player2.collectedSwords)
                app.chestMap[chestRow][chestCol] = 0
                if app.build == True:
                    for rowdy in range(-10, 10):
                        for coldx in range(-10, 10):
